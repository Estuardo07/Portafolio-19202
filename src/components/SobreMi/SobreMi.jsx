...
<div class="card"> 
   ...
   <div className={styles.body}>
     <p className={styles.text}>Hello, My name is <span>J</span>avier <span>E</span>stuardo <span>H</span>ernández <span>T</span>rigueros. I love technology and sports, the latter is where I acquired my discipline and perseverance, as I believe that sports are the most effective way to develop these qualities.
</p><span className={styles.username}>From:Javier_007</span>
