...
const FullStack = () => {
    return(
        <div className={styles.FullStack}>
            ...
            <span className={styles.span_mobile}>Javier Hernández</span>
            <div class="card">
   
   <div className={styles.body}> 
     <p className={styles.text}>Programmer with focus on web application development, I have skills in both Front-end and Back-end. however my specialty and main focus is in Front-end.</p><span className={styles.username}>From:Javier_007</span>
